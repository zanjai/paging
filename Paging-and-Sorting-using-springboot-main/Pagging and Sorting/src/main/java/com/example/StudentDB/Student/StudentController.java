...
public class StudentController {
    ...
    @GetMapping(path = "/pagingandsorting/{pageNumber}/{pageSize}/{sortDirection}")
    public Page<Student> studentPagination(@PathVariable("pageNumber") Integer pageNumber, @PathVariable("pageSize") Integer pageSize, @PathVariable("sortDirection") String sortDirection)  {
        return studentService.getStudentPagination(pageNumber, pageSize, sortDirection);
    }
}
